...
public class PrestarLibro extends javax.swing.JInternalFrame {
    ...
    LinkedList<LinkedList<String>> alAutores, alCategorias, alLibros, alUsuarios;
    ...
    private void initComponents() {
        ...
        jPanel2.add(cbBuscador, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 241, -1));
        ...
        jPanel2.add(cbOrdenarPor, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 100, -1));

        btnPrestarLibro.setBackground(new java.awt.Color(52, 128, 118));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/buscar_16x16.png"))); // NOI18N
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1110, -1));
    ...
    private void cargarUsuarios() {
        try{
            ...
            for(LinkedList<String> aux : alUsuarios)
            {
                cmbuser.addItem(aux.get(1));
            }
        }
        catch(SQLException e)
        {
